...
public class Waiting extends RunOnFailureKeywordsAdapter {
	 ...
	 */
	@Autowired
	protected static BrowserManagement browserManagement;
	...
	public static void waitForElementToLoad(String Xpath) {
		...
		WebDriverWait wait = new WebDriverWait(browserManagement.getCurrentWebDriver(), 60);
	...
	@RobotKeyword
	@ArgumentNames({ "text", "timeout=NONE", "message=NONE" })
	public static void waitForPageToLoad(String Xpath) {
	...
	public static void waitForPageLoaded() {
        ExpectedCondition<Boolean> expectation = new
                ExpectedCondition<Boolean>() {
                    public Boolean apply(WebDriver arg0) {
                        return ((JavascriptExecutor) browserManagement.getCurrentWebDriver()).executeScript("return document.readyState").toString().equals("complete");
                    }
        ...
        try {
            Thread.sleep(1000);
            WebDriverWait wait = new WebDriverWait(browserManagement.getCurrentWebDriver(), 30);
